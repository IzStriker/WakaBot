...
public class SubscriptionHandler
{
    ...
    {
        _messageQueue.Subscribe<TokenResponse>("auth:success", AuthSuccess);
        _messageQueue.Subscribe<ErrorResponse>("auth:fail", AuthFail);
    }

    private async Task AuthSuccess(TokenResponse res)
    {
    ...
    private async Task AuthFail(ErrorResponse res)
    {
        using var context = _contextFactory.CreateDbContext();
